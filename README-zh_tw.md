...
# ⚠️ 請不要分享此倉庫或 Hachimi 網站的連結
我們理解您希望幫助他人安裝 Hachimi 並獲得更好的遊戲體驗。然而，此項目本質上違反了遊戲的服務條款，若遊戲開發商得知，他們必定希望此項目消失。

在自行管理的聊天服務或私訊中分享是可以的，但我們懇請您不要在公開網站上分享此項目的連結，也不要分享任何相關工具的連結。

或者分享出去，毀掉數十位 Hachimi 用戶的體驗。這取決於您。

### 如果您仍要分享
請便，但我們懇請您在提及遊戲時，使用「UM:PD」或「那個賽馬遊戲」等代稱，而非遊戲的實際名稱，以避免被搜尋引擎索引。
...
# 構建
如需從原始碼構建 Hachimi Edge，請參閱 [BUILDING-zh_tw.md](BUILDING-zh_tw.md)。
